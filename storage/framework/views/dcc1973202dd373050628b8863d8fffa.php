...
<header class="main-section header">
    <a href="<?php echo e(url('/')); ?>"><img class="logo" src="icons/Лого.svg" alt=""></a>
    <div class="nav-menu">
        <nav>
            <a class="nav-menu__item" href="<?php echo e(url('/')); ?>">ГЛАВНАЯ</a>
            <a class="nav-menu__item" href="<?php echo e(url('/calc')); ?>">КАЛЬКУЛЯТОР</a>
            <a class="nav-menu__item" href="<?php echo e(url('/reviews')); ?>">ОТЗЫВЫ</a>
            <a class="nav-menu__item" href="<?php echo e(url('/galery')); ?>">ГАЛЕРЕЯ</a>
            <a class="nav-menu__item" href="<?php echo e(url('/contacts')); ?>">КОНТАКТЫ</a>
        </nav>
    </div>
</header>
        ...
        <div class="cards">
            ...
            <div class="card">
                ...
                <div class="soc-med-icon">
                    <a href="https://vk.com/stroyedom"><img width="60px" height="60px" src="img/vk.png" alt=""></a>
                    <a href="https://www.instagram.com/stroyedom/"><img width="60px" height="60px" src="img/inst.png" alt=""></a>
                </div>
            </div> 
        </div>
    </section>  
...
</html> <?php /**PATH /Users/admin/Desktop/mysite-main-backup 3/my-laravel-project/resources/views/contacts.blade.php ENDPATH**/ ?>